...
String photoUtilisateur=(String) request.getSession().getAttribute("photo");
	...
	<div class="container">
		...
		<div class="card m-3" style="width: 100%;">
			...
			<div class="card-body">
				...
				<a id="like" class="btn <%=color%>" onclick="like()">J'aime</a>
			...
			<div class="d-flex">
				<img class="card-img-top mx-3" src="data:image/jpeg;base64,<%=photoUtilisateur%>"
